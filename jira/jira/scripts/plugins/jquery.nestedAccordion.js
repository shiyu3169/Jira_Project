...
$.fn.accordion.defaults = {
  ...
  obj : 'div', // the element which contains the accordion - 'ul', 'ol', 'div' 
  objClass : '.accordion', // the class name of the accordion - required if you call the accordion on the container
  objID : '', // the ID of the accordion (optional)
  wrapper: 'div', // the common parent of 'a.trigger' and 'o.next' - 'li', 'div'
  el : '.h', // the parent of 'a.trigger' - 'li', '.h'
  head: 'h3, h4, h5', // the headings that are parents of 'a.trigger' (if any)
  next : 'div', // the collapsible element - 'ul', 'ol', 'div'
  initShow: '#current', // the initially expanded section (optional)
